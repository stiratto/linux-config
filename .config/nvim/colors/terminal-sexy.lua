...
local syntax = {
  ...
  Cursor = { ctermfg = 0, ctermbg = 'NONE' },
  CursorColumn = { ctermfg = 'NONE', ctermbg = 'NONE' },
  CursorLine = { ctermfg = 'NONE', ctermbg = 'NONE' },
  Directory = { ctermfg = 4 },
  ...
  Folded = { ctermfg = 8, ctermbg = 'NONE' },
  FoldColumn = { ctermfg = 6, ctermbg = 10 },
  SignColumn = { ctermfg = 3, ctermbg = 'NONE' },
  IncSearch = { ctermfg = 10, ctermbg = 3 },
  LineNr = { ctermfg = 8, ctermbg = 0 },
  CursorLineNr = { ctermfg = 8, ctermbg = 'NONE' },
...
local plugin_syntax = {
  -- Treesitter
  ["@markup.heading"] = { ctermfg = 3, bold = true },
  ["@markup.heading.2"] = { ctermfg = 9, bold = true },
  ["@markup.heading.3"] = { ctermfg = 1, bold = true },
  ["@markup.heading.4"] = { ctermfg = 14, bold = true },
  ...
  ["@markup.link.url"] = { ctermfg = 12 },
  ["@markup.list"] = { ctermfg = 4 },
  ["@markup.quote"] = { ctermfg = 12 },
...
function theme.load()
  ...
  vim.g.colors_name = "terminal-sexy"
